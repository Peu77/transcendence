...
> **Summary:** This project involves undertaking tasks you have never done before.
...
- [Chapter I — AI Instructions](#chapter-i--ai-instructions)
- [Chapter II — Preamble](#chapter-ii--preamble)
...
- [Chapter V — Project Ideas and Examples](#chapter-v--project-ideas-and-examples)
- [Chapter VI — README Requirements](#chapter-vi--readme-requirements)
- [Chapter VII — Bonus Part](#chapter-vii--bonus-part)
- [Chapter VIII — Submission and Peer-Evaluation](#chapter-viii--submission-and-peer-evaluation)
...
First, you will have to create a comprehensive `README.md` file. The detailed requirements for the README are specified in the [README Requirements](#chapter-vi--readme-requirements) section at the end of this document.
...
Building an entire project is complicated, and many things can go wrong. The requirements are the following:
...
> This module requires you to have implemented at least one game. The AI must be able to play your game competently.
...
- **[Major]** Multiplayer game (more than two players). *(Requires at least one existing game.)*
...
- **[Major]** Add another game with user history and matchmaking. *(Requires a functional first game.)*
...
- **[Minor]** Advanced chat features *(enhances the basic chat from the "User interaction" module — requires it to be implemented first)*.
...
- **[Minor]** Implement a tournament system. *(Requires at least one game.)*
  - Clear matchup order and bracket system.
  - Track who plays against whom.
  - Matchmaking system for tournament participants.
  - Tournament registration and management.
- **[Minor]** Game customization options. *(Requires at least one game.)*
...
- **[Minor]** Implement spectator mode for games. *(Requires at least one game.)*
...
|---|---|---|
| Gaming and user experience | Web-based game + Remote players + Tournament system + Game customization | 6 |
| User Management | Standard user management + OAuth | 3 |
| Web | Use frameworks (frontend + backend) + ORM | 3 |
...
- A **Description** section that clearly presents the project, including its goal and a brief overview, as well as a clear name for the project and its key features.
- An **Instructions** section containing all needed prerequisites (software, tools, versions, `.env` setup, etc.) and step-by-step instructions to run the project.
...
- **Team Information** — For each team member:
  - Assigned role(s): PO, PM, Tech Lead, Developer, etc.
...
You can have a maximum of **5 bonus points** (e.g., 5 minor modules, or 2 major modules + 1 minor module).
...
You can, for example, be asked to make a small update to a function or script, modify a display, or adjust a data structure to store new information.
