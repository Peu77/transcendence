...
setup: certs
	...
	@echo "VITE_BACKEND_URL=https://localhost:8443/api" > frontend/dev/.env.docker
	@echo "VITE_BACKEND_GITHUB_OAUTH_URL=https://localhost:8443/api/auth/github" >> frontend/dev/.env.docker
