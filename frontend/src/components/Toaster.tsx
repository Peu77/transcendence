...
export default function Toaster() {
  ...
  return (
    ...
    >
      {toasts.map((t) => (
        <div class={cn(variantClasses(t.variant), "p-[2px] clip-pixel-corners-btn",  t.closing ? "animate-toast-out" : "animate-toast-in")} role="status" key={t.id}>
          <div

            class={
            cn("pointer-events-auto clip-pixel-corners-btn border shadow-2xl px-3 py-2 bg-card text-card-foreground")
            }
          >
