        ...
        <ScrollArea className="h-[70vh] pr-4">
          <div className="space-y-6 text-foreground/80">
            <section>
              ...
              <p>
                By accessing or using Transcendence, you agree to be bound by
            ...
            <section>
              ...
              <p>
                Transcendence is a web-based multiplayer gaming platform
                developed as an educational project. It provides features such
                as real-time gaming, matchmaking, social interaction, and
            ...
            <section>
              ...
              <p>
                ...
                prohibited by these Terms. You are responsible for all of your
                activity in connection with the service.
              </p>
              <ul className="list-disc ml-6 mt-2 space-y-1">
                <li>
                  No cheating or using unauthorized third-party software to gain
                  an advantage in games.
                </li>
                <li>No harassment, bullying, or abuse of other users.</li>
                <li>
                  No posting of offensive, inappropriate, or illegal content.
                </li>
                <li>
                  No attempt to circumvent security measures or exploit
                  vulnerabilities.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Transcendence project team and its licensors.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                In no event shall the Transcendence project team be liable for
            ...
            <section>
              ...
              <p>
                ...
                the laws of the jurisdiction in which the project members
